...
public class MyLogger{
    ...
    public static enum DebugLevel {NONE, CONSTRUCTOR, FILE_PROCESSOR,BSTBUILDER, RESULTS,MAIN
                                   };
	...
	switch (levelIn) {
    case 5: debugLevel = DebugLevel.MAIN; break;
    case 4: debugLevel = DebugLevel.RESULTS; break;
    case 3: debugLevel = DebugLevel.BSTBUILDER; break;
